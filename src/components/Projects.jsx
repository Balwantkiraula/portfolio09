      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {featuredProjects.map((project) => (
            <div 
              key={project.id}
              className="group bg-gray-700 rounded-2xl overflow-hidden hover:bg-gray-600 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl"
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherProjects.map((project) => (
              <div 
                key={project.id}
                className="group bg-gray-700 rounded-xl overflow-hidden hover:bg-gray-600 transition-all duration-300 hover:transform hover:scale-105"
              >
